...
class GeneratedGame extends Phaser.Scene {
  ...
  create(){
    ...
    if(this.textures.exists("generated-environment"))this.add.image(W/2,H/2,"generated-environment").setDisplaySize(W,H).setAlpha(.72);else this.createProceduralBackdrop();
  ...
  makeTextures(){
    const g=this.make.graphics({x:0,y:0},false);g.fillStyle(0x000000,.28).fillEllipse(5,34,28,7);g.fillStyle(color(spec.art.palette[1])).fillRoundedRect(4,8,24,28,7);g.fillStyle(color(spec.art.palette[2])).fillTriangle(4,12,10,1,14,12).fillTriangle(18,12,23,1,28,12);g.fillStyle(0xffffff).fillRect(9,14,5,5).fillRect(19,14,5,5);g.fillStyle(0x172033).fillRect(11,16,2,2).fillRect(21,16,2,2);g.fillStyle(color(spec.art.palette[2])).fillRect(7,35,7,5).fillRect(19,35,7,5);g.generateTexture("hero",32,40);g.clear();
